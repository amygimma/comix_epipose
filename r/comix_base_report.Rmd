...
# CoMix social contact survey

### Country report for `r country_name_`

*Amy Gimma, Kerry Wong, Kevin Van Zandvoort, CMMID COVID-19 Working Group, London School of Hygiene and Tropical Medicine, Christopher Jarvis, John Edmunds*
...
<strong>Figure 2. Proportion of contacts by setting and wave for all contacts (individually reported and aggregated) and for individually-reported contacts only.</strong>
...
<strong>Figure 3. Proportion of contacts by duration of contact and wave.</strong>
...
<strong>Table 3. Proportion of contacts by setting and duration of contact and wave, with all contacts included.</strong>
...
<strong>Figure 5. Contact matrices by wave.</strong> Contacts truncated to 50 per participant per day, adjusted for day of week and country population by age using the World Population Prospect population data.
...
<strong>Figure 6. Adjusted contact means by participant age group.</strong> Contacts truncated to 50 per participant per day, adjusted for day of week and country population by age using the World Population Prospect population data.

```{r adjusted_mean_figure, fig.height = 3, fig.width = 9}

ggplot(adj_mean_contacts, aes(y = mean_contacts, x = participant_age,
...
<strong>Table 5. Adjusted contact means by participant age group.</strong> Contacts truncated to 50 per participant per day, adjusted for day of week and country population by age using the World Population Prospect population data.

```{r adjusted_mean_table}
kable(adj_mean_contacts_table, digits = 2) %>% kable_styling()
```
...
2.  Jarvis CI, Van Zandvoort K, Gimma A, et al. Quantifying the impact of physical distance measures on the transmission of COVID-19 in the UK. 2020;18: 124.
